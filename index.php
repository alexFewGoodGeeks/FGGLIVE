...
<head class="test pipeline-test">
    ...
    <title>GEEKS provide a universal FIX, everything we touch simply CLICKS!</title>
        ...
        <div class="carousel-inner">
            <div class="item html5-video-container active">
                ...
                <div class="carousel-caption">
                    <!--FewGoodGeeks animation-->
                    <h1 class="animated slideInDown main-title">
                        <span class="letter-jump">F</span>
                        <span class="letter-jump">e</span>
                        <span class="letter-jump">w</span>
                        <span class="letter-jump">G</span>
                        <span class="letter-jump">o</span>
                        <span class="letter-jump">o</span>
                        <span class="letter-jump">d</span>
                        <span class="letter-jump">G</span>
                        <span class="letter-jump">e</span>
                        <span class="letter-jump">e</span>
            ...
            <div class="row fgg-about">
                <div class="col-md-12">
                    ...
                    <p>We are a geek squad of highly skilled techy individuals with a passion for solving problems.
                        Although <b>FewGoodGeeks</b> is a very young company, we have been in the industry for almost a
                        decade. We implement IT projects, offer dedicated development resources on site or remotely and
                        assist in maintenance of systems and applications. Our geeks <b>turn your ideas into reality</b>
                        and together, we build them into great products.</p>
                    <blockquote>
    ...
    <section id="sci_design" class="contact content-section">
        <div class="container">
            <div class="row text-center">
                <div class="col-md-12">
                    <h2><b>Scientific Covers and Illustrations</b></h2>
                    <h3 class="caption gray">Few Good Geeks is a name that houses a gang of individuals whose only power
        ...
        <div class="container project-container text-center">
            <div class="recent-project-carousel owl-carousel owl-theme popup-gallery">
                <div class="item recent-project">
                    <span class="logo-box"><img src="assets/images/Partner-logos/Devsy-logo.png" alt=""
                            class="img-responsive" id="logo-inside-2"></span>
                    <div class="project-info">
                        <h3>Devsy</h3>
                        <ul class="project-meta">
                            <li><a href="http://www.devsy.com" target="_blank">Visit Website</a></li>
                        </ul>
                    </div>
                </div>

                <div class="item recent-project">
                    <span class="logo-box"><img src="assets/images/Partner-logos/Logo-maxi-Transparent.png" alt=""
                            class="img-responsive" id="logo-inside-2"></span>
                    <div class="project-info">
                        <h3>Avicenna</h3>
                        <ul class="project-meta">
                ...
                <div class="item recent-project">
                    <span class="logo-box"><img src="assets/images/Partner-logos/eyetea-logo.png" alt=""
                            class="img-responsive" id="logo-inside-2"></span>
                    <div class="project-info">
                        <h3>Eyetea Solutions</h3>
                        <ul class="project-meta">
                            <li><a href="http://eyetea.mk/" target="_blank">Visit Website</a></li>
                        </ul>
                    </div>
                </div>

                <div class="item recent-project">
                    <span class="logo-box"><img src="assets/images/Partner-logos/BizSpark.png" alt=""
                            class="img-responsive" id="logo-inside-2"></span>
                    <div class="project-info">
                        <h3>Microsoft BizSpark</h3>
                        <ul class="project-meta">
                            <li><a href="https://bizspark.microsoft.com/" target="_blank">Visit Website</a></li>
                        </ul>
                    </div>
                </div>
